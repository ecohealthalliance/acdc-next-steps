...
Some of the salient points related to this are discussed in point 2 above. In addition, we will need to spend time with those responsible for update and maintenance of the database with regard to the protocols and process of updated particularly with the advent of our new main source which is the Pandemic PACT dataset. Tasks related to this are:
